...
## Project Structure
    ...
    ├── beech_finance_holdi_30302  # Django project configurations
...
1. Clone this repo and `cd beech_finance_holdi_30302`
...
2. Clone this repo and `cd beech_finance_holdi_30302`
